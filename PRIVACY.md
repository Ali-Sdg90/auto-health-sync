...
Health Data Relay processes health data only to create the backups explicitly described in the app.
...
- Health Data Relay does not independently store Google OAuth access tokens.
